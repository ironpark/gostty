...
func (tab *terminal) encodeMouse(action input.MouseAction, button input.MouseButton, hasButton bool, px, py int, m keys.Mods, anyPressed bool) error {
	ev := input.MouseEvent{
		Action:    action,
		Button:    button,
		HasButton: hasButton,
