...
typedef struct zg_format_options {
    zg_formatter_format format;
    uint8_t unwrap;
    uint8_t keep_trailing_whitespace;
    uint8_t cursor;
    uint8_t no_styles;
...
typedef struct zg_feed_boundary {
    size_t consumed;
    uint8_t reached;
} zg_feed_boundary;
...
ZIGO_EXPORT int32_t zg_osc_parser_command(const zg_osc_parser * self, uint8_t * out_result);
ZIGO_EXPORT int32_t zg_osc_parser_window_title(const zg_osc_parser * self, const uint8_t * * out_result_ptr, size_t * out_result_len);
ZIGO_EXPORT int32_t zg_osc_parser_icon(const zg_osc_parser * self, const uint8_t * * out_result_ptr, size_t * out_result_len);
ZIGO_EXPORT int32_t zg_osc_parser_pwd(const zg_osc_parser * self, const uint8_t * * out_result_ptr, size_t * out_result_len);
ZIGO_EXPORT int32_t zg_osc_parser_hyperlink_uri(const zg_osc_parser * self, const uint8_t * * out_result_ptr, size_t * out_result_len);
ZIGO_EXPORT int32_t zg_osc_parser_hyperlink_id(const zg_osc_parser * self, const uint8_t * * out_result_ptr, size_t * out_result_len);
ZIGO_EXPORT int32_t zg_osc_parser_notification_title(const zg_osc_parser * self, const uint8_t * * out_result_ptr, size_t * out_result_len);
ZIGO_EXPORT int32_t zg_osc_parser_notification_body(const zg_osc_parser * self, const uint8_t * * out_result_ptr, size_t * out_result_len);
ZIGO_EXPORT int32_t zg_osc_parser_clipboard_data(const zg_osc_parser * self, const uint8_t * * out_result_ptr, size_t * out_result_len);
ZIGO_EXPORT int32_t zg_osc_parser_clipboard_selection(const zg_osc_parser * self, uint8_t * out_result);
ZIGO_EXPORT int32_t zg_osc_parser_mouse_shape(const zg_osc_parser * self, const uint8_t * * out_result_ptr, size_t * out_result_len);
ZIGO_EXPORT int32_t zg_osc_parser_semantic_prompt_action(const zg_osc_parser * self, uint8_t * out_result);
ZIGO_EXPORT int32_t zg_osc_parser_semantic_prompt_options(const zg_osc_parser * self, const uint8_t * * out_result_ptr, size_t * out_result_len);
ZIGO_EXPORT int32_t zg_osc_parser_progress_state(const zg_osc_parser * self, uint8_t * out_result);
ZIGO_EXPORT int32_t zg_osc_parser_progress_value(const zg_osc_parser * self, int16_t * out_result);
...
ZIGO_EXPORT int32_t zg_render_state_cursor_style(const zg_render_state * self, uint8_t * out_result);
...
ZIGO_EXPORT uint8_t zg_key_from_w3c(const uint8_t * w3cCode_ptr, size_t w3cCode_len, int32_t * out_result);
...
ZIGO_EXPORT int32_t zg_terminal_new_search(zg_terminal * self, const uint8_t * needle_ptr, size_t needle_len, zg_search * * out_result);
...
ZIGO_EXPORT int32_t zg_terminal_print_repeat(zg_terminal * self, size_t count);
...
ZIGO_EXPORT int32_t zg_terminal_set_cursor_pos(zg_terminal * self, size_t row, size_t col);
...
ZIGO_EXPORT int32_t zg_terminal_cursor_up(zg_terminal * self, size_t count);
ZIGO_EXPORT int32_t zg_terminal_cursor_down(zg_terminal * self, size_t count);
ZIGO_EXPORT int32_t zg_terminal_cursor_left(zg_terminal * self, size_t count);
ZIGO_EXPORT int32_t zg_terminal_cursor_right(zg_terminal * self, size_t count);
...
ZIGO_EXPORT int32_t zg_terminal_set_top_and_bottom_margin(zg_terminal * self, size_t top, size_t bottom);
ZIGO_EXPORT int32_t zg_terminal_set_left_and_right_margin(zg_terminal * self, size_t left, size_t right);
...
ZIGO_EXPORT int32_t zg_terminal_delete_chars(zg_terminal * self, size_t count);
ZIGO_EXPORT int32_t zg_terminal_erase_chars(zg_terminal * self, size_t count);
...
ZIGO_EXPORT int32_t zg_screen_selection(zg_screen * self, uint8_t * out_result_has, zg_selection * out_result);
ZIGO_EXPORT int32_t zg_screen_set_selection(zg_screen * self, const zg_selection * sel, uint8_t * out_result);
ZIGO_EXPORT int32_t zg_screen_viewport_top(zg_screen * self, uint32_t * out_result);
ZIGO_EXPORT int32_t zg_screen_scrollbar(zg_screen * self, zg_scrollbar * out_result);
ZIGO_EXPORT int32_t zg_screen_format(zg_screen * self, const zg_format_options * opts, size_t writer_userdata);
...
ZIGO_EXPORT int32_t zg_search_feed(zg_search * self, uint8_t active_dirty);
ZIGO_EXPORT int32_t zg_search_all(zg_search * self);
ZIGO_EXPORT int32_t zg_search_select(zg_search * self, uint8_t to, uint8_t scroll, uint8_t * out_result);
ZIGO_EXPORT int32_t zg_search_match_count(zg_search * self, size_t * out_result);
ZIGO_EXPORT int32_t zg_search_matches(zg_search * self, zg_selection * dst_ptr, size_t dst_len, size_t * out_result);
...
ZIGO_EXPORT int32_t zg_clipboard_request_clear_reply_contents(zg_clipboard_request * self);
ZIGO_EXPORT int32_t zg_clipboard_request_reply_contents(zg_clipboard_request * self, uint8_t remember);
ZIGO_EXPORT int32_t zg_clipboard_request_deny(zg_clipboard_request * self, uint8_t reason);
ZIGO_EXPORT int32_t zg_clipboard_request_add_content(zg_clipboard_request * self, const uint8_t * mime_type_ptr, size_t mime_type_len, const uint8_t * data_ptr, size_t data_len);
...
ZIGO_EXPORT int32_t zg_render_state_cursor(zg_render_state * self, uint64_t * out_result);
...
ZIGO_EXPORT void zg_free_buffer(uint8_t * buffer_ptr, size_t buffer_len);
